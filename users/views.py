...
def login(request):
    ...
    response = JsonResponse({'user': {'id': user.id, 'student_id': user.student_id,'name': user.name,'sem': user.sem, 'email':user.email}, 'message': 'user logged in successfully'}, status=200)
